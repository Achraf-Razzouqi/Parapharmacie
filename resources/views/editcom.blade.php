            ...
            <div class="col-lg-4 col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="{{ url('gescom/'.$Commande->id)}}" method="post">
                    <input type="hidden" name="_method" value="PUT">
                    {{ csrf_field()}}
                    <div class="form-group">
                      <input type="text" class="form-control" name="montant" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Entrer le montant du commande" value="{{$Commande->montant}}">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" name="idClient" id="exampleInputPassword1" placeholder="Entrer l'id du client" value="{{$Commande->idClient}}">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" name="idProduit" id="exampleInputPassword1" placeholder="Entrer l'id du produit" value="{{$Commande->idProduit}}">
                    </div>
