            ...
            <div class="col-lg-4 col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="{{ url('FOURgesprod')}}" method="post">
                    {{ csrf_field()}}
                  ...
                  {{-- {{$four}} --}}
                    ...
                    <div class="form-group">
                      <input type="hidden" value="{{session('data')['id']}}" class="form-control" name="idFournisseur" id="exampleInputPassword1" placeholder="Entrer l'idFournisseur">
                    </div>
                    ...
                    <tbody>
                          @foreach($listprod as $prod)
                            <tr>
                              ...
                              <td>{{$prod->img}}</td>
                              <td>
                                <form action="{{url('FOURgesprod/'.$prod->id)}}" method="post">
                                  
                                  {{ csrf_field() }}
                                  {{ method_field('DELETE')}}
                                   <a href="{{url('FOURgesprod/'.$prod->id.'/edit')}}" class="btn btn-default">editer</a>
