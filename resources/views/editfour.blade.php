            ...
            <div class="col-lg-4 col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="{{ url('gesfour/'.$Fournisseur->id)}}" method="post">
                    <input type="hidden" name="_method" value="PUT">
                    {{ csrf_field()}}
                    <div class="form-group">
                      <input type="text" class="form-control" value="{{$Fournisseur->nomComplet}}" name="nomComplet" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter le nom complet">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" value="{{$Fournisseur->password}}" name="password" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter le mot de passe">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" value="{{$Fournisseur->adresse}}" name="adresse" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter l'adresse">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" value="{{$Fournisseur->tel}}" name="tel" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter le numero de telphone">
                    </div>
