...
<body>
  ...
  <form action="{{ route('shop.search'),  route('shop.show') }}" method="get" >
    @csrf
    <?php
    if(Auth::user()==null)
           {
          ...
          <div class="icons">
            ...
            <a href="#" class="site-menu-toggle js-menu-toggle ml-3 d-inline-block d-lg-none"><span
              class="icon-menu"></span></a>     <br>
                     ...
                     <input type="text" id="a" name="se" >
                     {{-- <input type="submit" > --}}
                     <button type="input" name="nomSD" class="btn btn-success icon-search" style="height: 35px;"></button>
      ...
      <div class="container" style="background: white">
        <div class="row d-flex contact-info">
          ...
          <div class="col-md-3 d-flex">
            ...
            <a href="{{url('shop-single',$produit->id)}}" class='btn btn-primary'>acheter</a>
