            ...
            <div class="col-lg-4 col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                   ...
                   <form action="{{ url('FOURgescat/'.$Categorie->id)}}" method="post">
                    <input type="hidden" name="_method" value="PUT">
                    {{ csrf_field()}}
                    <div class="form-group">
                      <input type="text" name="nom" value="{{$Categorie->nom}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter le nom de la categorie">
                    </div>
