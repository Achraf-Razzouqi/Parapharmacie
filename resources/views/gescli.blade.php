            ...
            <div class="col-lg-4 col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="{{ url('gescli')}}" method="post">
                    {{ csrf_field()}}
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" name="img" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter l'image">
                    </div>
                    ...
                    <tbody>
                         @foreach($listcli as $cli)
                            <tr>
                              ...
                              <td>{{$cli->type}}</td>
                              <td>
                                <form action="{{url('gescli/'.$cli->id)}}" method="post">
                                  
                                  {{ csrf_field() }}
                                  {{ method_field('DELETE')}}
                                   <a href="{{url('gescli/'.$cli->id.'/edit')}}" class="btn btn-default">editer</a>
                                   <a href="{{url('/destroyCl',$cli->id)}}" class="btn btn-danger height-auto">Supprimer </a>
                                </form>
                              </td>
                            </tr>
